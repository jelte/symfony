...
@trigger_error('The '.__NAMESPACE__.'\Profile class is deprecated since Symfony 3.0 and will be removed in 3.1. Use Symfony\Component\Profiler\Profile instead.', E_USER_DEPRECATED);
